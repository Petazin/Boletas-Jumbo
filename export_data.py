...
def main():
    ...
    try:
        ...
        with db_connection() as conn:
            ...
            # Usar pandas para leer los resultados de la consulta directamente en un DataFrame
        ...
        # encoding='utf-8-sig' asegura la compatibilidad con caracteres especiales (tildes, etc.) en Excel.
