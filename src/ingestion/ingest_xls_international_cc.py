...
def main():
    ...
    xls_directory = r'C:\Users\Petazo\Desktop\Boletas Jumbo\fuentes\Banco\Banco de Chile\tarjeta de credito\internacional'
    # source_name se determina dinámicamente ahora
    ...
    with db_connection() as conn:
        ...
        for xls_path in xls_files:
            ...
            instrument_type = "Tarjeta de Crédito Internacional"
