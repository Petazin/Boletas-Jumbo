...
def main():
    xls_directory = r'C:\Users\Petazo\Desktop\Boletas Jumbo\fuentes\Banco\Falabella\tarjeta de credito\nacional'
        ...
        for xls_path in xls_files:
            ...
            try:
                ...
                try:
                    ...
                    source_institution = path_parts[fuentes_index + 2]  # e.g., 'Falabella'
                except (ValueError, IndexError) as e:
                    logging.error(f"No se pudo determinar la institución desde la ruta del archivo: {xls_path}. Error: {e}")
                    continue
                
                # Para la tabla 'fuentes', el tipo es el instrumento financiero.
