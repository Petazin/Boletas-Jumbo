...
ORGANIZED_DIR = os.path.join(BASE_DIR, "fuentes", "retail", "Jumbo")

# Directorio donde se moverán los PDFs que no puedan ser procesados correctamente.
QUARANTINE_DIR = os.path.join(BASE_DIR, "cuarentena")
...
DOWNLOAD_LOG_FILE = os.path.join(BASE_DIR, "logs", "download_boletas.log")
PROCESS_LOG_FILE = os.path.join(BASE_DIR, "logs", "process_boletas.log")
